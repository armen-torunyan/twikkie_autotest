...
class SeleniumDriver:
    ...
    def get_elements_nested(self, parent_webElem, child_locator, locator_type="xpath"):
        """
    ...
    def get_element_nested(self, parent_webElem, child_locator, locator_type="xpath"):
        """
    ...
    def clear_input_fields(self, locator, locator_type="xpath"):
        try:
            element = self.get_element(locator, locator_type)
            element.clear()
    ...
    def click_on_element_by_xpath_text(self, element, text, locator_type="xpath"):
        """
        This method is designed to verify given attribute value
        :param element: The element selector
    ...
    def scroll_into_view(self, element, type='xpath'):
        """
